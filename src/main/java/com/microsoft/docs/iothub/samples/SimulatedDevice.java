    ...
    public void run() {
      try {
        ...
        while (true) {
          ...
          double currentPressure = minPressure + rand.nextDouble() * 30;
          String deviceNo = "deviceID_" + String.valueOf(rand.nextInt(5));

          TelemetryDataPoint telemetryDataPoint = new TelemetryDataPoint();
          telemetryDataPoint.temperature = currentTemperature;
          telemetryDataPoint.humidity = currentHumidity;
          telemetryDataPoint.pressure = currentPressure;
          telemetryDataPoint.deviceId = deviceNo;
          telemetryDataPoint.metricId = UUID.randomUUID().toString();
